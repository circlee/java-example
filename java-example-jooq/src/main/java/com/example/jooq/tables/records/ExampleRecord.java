...
public class ExampleRecord extends UpdatableRecordImpl<ExampleRecord> implements Record14<Long, String, String, String, Byte, Integer, BigDecimal, Date, Time, Timestamp, Long, Timestamp, Long, Timestamp> {

    private static final long serialVersionUID = 1955315314;
    ...
    /**
     * Setter for <code>schema.example.birth</code>.
     */
    ...
    /**
     * Getter for <code>schema.example.birth</code>.
     */
    ...
    /**
     * Setter for <code>schema.example.sleep</code>.
     */
    ...
    /**
     * Getter for <code>schema.example.sleep</code>.
     */
     ...
     */
    @Override
    public Row14<Long, String, String, String, Byte, Integer, BigDecimal, Date, Time, Timestamp, Long, Timestamp, Long, Timestamp> fieldsRow() {
     ...
     */
    @Override
    public Row14<Long, String, String, String, Byte, Integer, BigDecimal, Date, Time, Timestamp, Long, Timestamp, Long, Timestamp> valuesRow() {
     ...
     */
    @Override
    public ExampleRecord value14(Timestamp value) {
        setVersion(value);
        return this;
    }
     ...
     */
    @Override
    public ExampleRecord values(Long value1, String value2, String value3, String value4, Byte value5, Integer value6, BigDecimal value7, Date value8, Time value9, Timestamp value10, Long value11, Timestamp value12, Long value13, Timestamp value14) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ExampleRecord(Long id, String name, String code, String state, Byte grade, Integer score, BigDecimal price, Date birth, Time sleep, Timestamp createddate, Long createdby, Timestamp modifieddate, Long modifiedby, Timestamp version) {
        super(Example.EXAMPLE);
