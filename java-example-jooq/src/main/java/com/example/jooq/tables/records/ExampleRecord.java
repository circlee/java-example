...
public class ExampleRecord extends UpdatableRecordImpl<ExampleRecord> implements Record11<Long, String, String, String, Byte, Integer, BigDecimal, Timestamp, Long, Timestamp, Long> {

    private static final long serialVersionUID = -1619251677;
     ...
     */
    @Override
    public Row11<Long, String, String, String, Byte, Integer, BigDecimal, Timestamp, Long, Timestamp, Long> fieldsRow() {
     ...
     */
    @Override
    public Row11<Long, String, String, String, Byte, Integer, BigDecimal, Timestamp, Long, Timestamp, Long> valuesRow() {
     ...
     */
    @Override
    public ExampleRecord value8(Timestamp value) {
     ...
     */
    @Override
    public ExampleRecord value9(Long value) {
        setCreatedby(value);
        return this;
    }
     ...
     */
    @Override
    public ExampleRecord values(Long value1, String value2, String value3, String value4, Byte value5, Integer value6, BigDecimal value7, Timestamp value8, Long value9, Timestamp value10, Long value11) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ExampleRecord(Long id, String name, String code, String state, Byte grade, Integer score, BigDecimal price, Timestamp createddate, Long createdby, Timestamp modifieddate, Long modifiedby) {
        super(Example.EXAMPLE);
